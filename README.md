...
> **Русскоязычным пользователям:** [открыть полную документацию на русском языке](README.ru.md)
...
[Русская документация](README.ru.md) · [Changelog](CHANGELOG.md) · [Contributing](CONTRIBUTING.md) · [Security](SECURITY.md) · [Support](#support-and-feedback)
...
<p align="center">
  <img src="docs/screenshots/widget-home-screen-black.png" width="220" alt="Widget displaying the current time and next Samsung Clock alarm on the One UI home screen">
  &nbsp;
  <img src="docs/screenshots/widget-reconfigure-menu-black.png" width="220" alt="One UI widget menu with the option to reopen the widget settings">
  &nbsp;
